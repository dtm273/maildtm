...
$config['asset_path'] 		= 'assets/backend/';
$config['css_path'] 			= 'assets/backend/';
$config['download_path'] 	= 'assets/backend/download/';
$config['less_path'] 			= 'assets/backend/less/';
$config['js_path'] 				= 'assets/backend/';
$config['img_path'] 			= 'assets/backend/img/';
$config['swf_path'] 			= 'assets/backend/swf/';
$config['upload_path'] 		= 'assets/backend/upload/';
$config['xml_path'] 			= 'assets/backend/xml/';
