<div class="row-fluid">
    <div class="span12">
        ...
        <h3 class="heading"><?php echo $lang->line('page_title'); ?></h3>		
        <div role="grid" class="dataTables_wrapper form-inline" id="dt_a_wrapper">
            <form class="form-horizontal" method="post" action="<?php echo $action ?>" name="adminForm" id="adminForm">
                <div class="row">				
                    <div class="span6">
                        <label><?php echo $lang->line('search') .' theo version'; ?>: 
                ...
                <div class="row">
                    <div class="span6">
                        <label><?php echo $lang->line('search') .' theo os type'; ?>: 
                            <input type="text" aria-controls="search_by_parent" id="search_by_parent" value="<?php echo $data['keyword_osType']; ?>">
                        </label>
