    ...
    <div class="span12">
        ...
        <div role="grid" class="dataTables_wrapper form-inline" id="dt_a_wrapper">
            <form class="form-horizontal" method="post" action="" name="adminForm" id="adminForm">
                <div class="row">				
                    <div class="span6">
                        <label><?php echo $lang->line('search'); ?>: <input type="text" aria-controls="search" id="search" value="<?php echo $data['keyword']; ?>"></label>
                ...
                <div class="row">
                    <div class="span6">
                        <label><?php echo 'Tìm theo nhóm'; ?>: 
                            <input type="text" aria-controls="search_by_parent" id="search_by_parent" value="<?php echo $data['parent_keyword']; ?>">
                        </label>
                        <?php echo img('gCons/search.png', array('id' => 'search_parent_button')); ?>
                        <?php echo img('ajax_loader.gif', array('class' => 'ajax_waiting')); ?>
                    </div>
                </div>
